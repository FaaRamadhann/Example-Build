@echo off
rem ============================================================
rem  ex-build.bat — CONTOH build APK Android TANPA Android Studio
rem  (cukup JDK + Android SDK build-tools)
rem
rem  Cara pakai:
rem    1. Copy file ini ke ROOT project Android kamu.
rem    2. Sesuaikan blok KONFIG di bawah.
rem    3. Jalankan dari root project:  ex-build.bat
rem
